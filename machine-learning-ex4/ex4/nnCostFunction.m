...
error = (lambda/(2*m)) * (sum(sum(temp_Theta1.^2)) + sum(sum(temp_Theta2.^2)));
...
Theta1_grad = 1/m * del1 + (lambda/m)*[zeros(size(Theta1, 1), 1) temp_Theta1];
Theta2_grad = 1/m * del2 + (lambda/m)*[zeros(size(Theta2, 1), 1) temp_Theta2];
% -------------------------------------------------------------
